...
DROP TABLE IF EXISTS lowvoltage.sepsis_ecg_lqrs_broad_official;
...
CREATE TABLE lowvoltage.sepsis_ecg_lqrs_broad_official AS
SELECT
    b.*,
    se.ecg_study_id,
    se.ecg_time,
...
CREATE UNIQUE INDEX sepsis_ecg_lqrs_broad_official_stay_idx
    ON lowvoltage.sepsis_ecg_lqrs_broad_official (stay_id);
ANALYZE lowvoltage.sepsis_ecg_lqrs_broad_official;
...
FROM lowvoltage.sepsis_ecg_lqrs_broad_official;
