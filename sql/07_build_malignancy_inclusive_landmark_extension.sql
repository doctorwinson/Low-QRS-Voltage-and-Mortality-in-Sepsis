/*
Purpose:
  Build the complete malignancy-inclusive landmark-selection population and derive a
...
Key rules:
  ...
  - Preserve all otherwise eligible adult Sepsis-3 stays so selection into the
    landmark cohort can be described directly.
*/

BEGIN;

DROP TABLE IF EXISTS lowvoltage.landmark_extension_inclusive_20260804;
...
CREATE TABLE lowvoltage.landmark_extension_inclusive_20260804 AS
SELECT
    b.*,
    s.n_ecg_post_24h,
...
CREATE UNIQUE INDEX landmark_extension_inclusive_20260804_stay_idx
    ON lowvoltage.landmark_extension_inclusive_20260804 (stay_id);
CREATE INDEX landmark_extension_inclusive_20260804_group_idx
    ON lowvoltage.landmark_extension_inclusive_20260804 (landmark_selection_group);
ANALYZE lowvoltage.landmark_extension_inclusive_20260804;
