/*
Purpose:
  Build a malignancy-inclusive post-admission 24-hour ECG cohort for the
...
Key implementation details:
  ...
  3. Join ECG records to ICU stays by subject_id and 0-24 hours after ICU intime.
...
Selection rule for one ECG per stay:
  - Prefer a low-QRS ECG within the ICU 0-24h window.
...
voltage within the ICU 0-24h post-admission window".
*/
...
DROP TABLE IF EXISTS lowvoltage.sepsis_ecg_lqrs_post_icu_24h_malignancy_inclusive;
...
CREATE TABLE lowvoltage.sepsis_ecg_lqrs_post_icu_24h_malignancy_inclusive AS
SELECT
    b.*,
    se.ecg_study_id,
    se.ecg_time,
...
CREATE UNIQUE INDEX sepsis_ecg_lqrs_post_icu_24h_malignancy_inclusive_stay_idx
    ON lowvoltage.sepsis_ecg_lqrs_post_icu_24h_malignancy_inclusive (stay_id);
ANALYZE lowvoltage.sepsis_ecg_lqrs_post_icu_24h_malignancy_inclusive;
...
FROM lowvoltage.sepsis_ecg_lqrs_post_icu_24h_malignancy_inclusive;
