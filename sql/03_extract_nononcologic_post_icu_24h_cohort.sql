/*
Purpose:
  Build the final analysis extraction for the sepsis and ECG low-QRS voltage
  study.
...
DROP TABLE IF EXISTS lowvoltage.sepsis_ecg_lqrs_post_icu_24h_official;
...
CREATE TABLE lowvoltage.sepsis_ecg_lqrs_post_icu_24h_official AS
SELECT
    b.*,
    se.ecg_study_id,
    se.ecg_time,
...
CREATE UNIQUE INDEX sepsis_ecg_lqrs_post_icu_24h_official_stay_idx
    ON lowvoltage.sepsis_ecg_lqrs_post_icu_24h_official (stay_id);
ANALYZE lowvoltage.sepsis_ecg_lqrs_post_icu_24h_official;
...
FROM lowvoltage.sepsis_ecg_lqrs_post_icu_24h_official;
